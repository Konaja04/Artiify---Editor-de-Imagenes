 ...
 * @author l34314
 */
public class PixelarVentana extends javax.swing.JFrame {
    ...
    public PixelarVentana(BufferedImage IMG) {
        initComponents(); 
    ...
    private void SLIDERMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SLIDERMouseReleased
        ...
        if(IMAGENCLASE!=null)
        {
            ...
            this.imagenFiltrada=this.IMAGENCLASE.Pixelar(value);
