 ...
 * @author l34314
 */
public class BoxBlurVentana extends javax.swing.JFrame {
    ...
    public BoxBlurVentana(BufferedImage IMG) {
        initComponents(); 
    ...
    private void SLIDERMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SLIDERMouseReleased
        ...
        if(IMAGENCLASE!=null)
        {
            ...
            this.imagenFiltrada=this.IMAGENCLASE.boxBlur(value);
