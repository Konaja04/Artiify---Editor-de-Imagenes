 ...
 * @author l34314
 */
public class HighPassVentana extends javax.swing.JFrame {
    ...
    public HighPassVentana(BufferedImage IMG) {
        initComponents(); 
    ...
    private void SLIDERMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SLIDERMouseReleased
        ...
        if(IMAGENCLASE!=null)
        {
            ...
            this.imagenFiltrada=this.IMAGENCLASE.HighPassFilter(value);
